...
template<int SizeAtCompileType> void mixingtypes_part2(int size = SizeAtCompileType)
{
  typedef std::complex<float>   CF;
  typedef std::complex<double>  CD;
  typedef Matrix<float, SizeAtCompileType, SizeAtCompileType> Mat_f;
...
template<int SizeAtCompileType> void mixingtypes_part3(int size = SizeAtCompileType)
{
  typedef std::complex<float>   CF;
  typedef std::complex<double>  CD;
  typedef Matrix<float, SizeAtCompileType, SizeAtCompileType> Mat_f;
...
void test_mixingtypes()
{
  for(int i = 0; i < g_repeat; i++) {
    ...
    CALL_SUBTEST_2(mixingtypes_part2<3>());
    CALL_SUBTEST_3(mixingtypes_part3<3>());

    CALL_SUBTEST_4(mixingtypes<4>());
    CALL_SUBTEST_5(mixingtypes_part2<4>());
    CALL_SUBTEST_6(mixingtypes_part3<4>());

    CALL_SUBTEST_7(mixingtypes<Dynamic>(internal::random<int>(1, EIGEN_TEST_MAX_SIZE)));
    CALL_SUBTEST_8(mixingtypes_part2<Dynamic>(internal::random<int>(1, EIGEN_TEST_MAX_SIZE)));
    CALL_SUBTEST_9(mixingtypes_part3<Dynamic>(internal::random<int>(1,EIGEN_TEST_MAX_SIZE)));

    CALL_SUBTEST_11(mixingtypes<3>());
    CALL_SUBTEST_12(mixingtypes_part2<3>());
    CALL_SUBTEST_13(mixingtypes_part3<3>());

    CALL_SUBTEST_14(mixingtypes<4>());
    CALL_SUBTEST_15(mixingtypes_part2<4>());
    CALL_SUBTEST_16(mixingtypes_part3<4>());

    CALL_SUBTEST_17(mixingtypes<Dynamic>(internal::random<int>(1, EIGEN_TEST_MAX_SIZE)));
    CALL_SUBTEST_18(mixingtypes_part2<Dynamic>(internal::random<int>(1, EIGEN_TEST_MAX_SIZE)));
    CALL_SUBTEST_19(mixingtypes_part3<Dynamic>(internal::random<int>(1,EIGEN_TEST_MAX_SIZE)));
  }
}
