...
struct DenseFunctor : public LevenbergMarquardtFunctor<_Scalar, NX, NY>
{
  ...
  typedef Matrix<Scalar,Base::ValuesAtCompileTime,Base::InputsAtCompileTime> JacobianType;  // prepend Base:: by pmkalshetti (Ref: http://www.cs.technion.ac.il/users/yechiel/c++-faq/nondependent-name-lookup-members.html)
  typedef ColPivHouseholderQR<JacobianType> QRSolver;

  DenseFunctor() : Base(Base::InputsAtCompileTime, Base::ValuesAtCompileTime) {}    // prepend Base:: by pmkalshetti (Ref: http://www.cs.technion.ac.il/users/yechiel/c++-faq/nondependent-name-lookup-members.html)
