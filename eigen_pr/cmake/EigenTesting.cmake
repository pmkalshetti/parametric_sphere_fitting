...
macro(ei_add_test testname)
  ...
  if(EIGEN_SPLIT_LARGE_TESTS AND suffixes)
    ...
    GET_PROPERTY( EIGEN_CURRENT_SUBPROJECT GLOBAL PROPERTY EIGEN_CURRENT_SUBPROJECT)
    SET_TARGET_PROPERTIES( ${testname} PROPERTIES FOLDER "${EIGEN_CURRENT_SUBPROJECT}/test/${testname}" ) 
    foreach(suffix ${suffixes})
      ei_add_test_internal(${testname} ${testname}_${suffix}
        "${ARGV1} -DEIGEN_TEST_PART_${suffix}=1" "${ARGV2}")
      add_dependencies(${testname} ${testname}_${suffix})
      SET_TARGET_PROPERTIES( ${testname}_${suffix} PROPERTIES FOLDER "${EIGEN_CURRENT_SUBPROJECT}/test/${testname}" ) 
    endforeach(suffix)
    ...
    GET_PROPERTY( EIGEN_CURRENT_SUBPROJECT GLOBAL PROPERTY EIGEN_CURRENT_SUBPROJECT)
    SET_TARGET_PROPERTIES( ${testname} PROPERTIES FOLDER "${EIGEN_CURRENT_SUBPROJECT}/test" ) 
...
macro(ei_is_64bit_env VAR)
  ...
  elseif(CMAKE_SIZEOF_VOID_P EQUAL 4)
    ...
    message(WARNING "Unsupported pointer size [${CMAKE_SIZEOF_VOID_P}]. Please contact the authors.")
  endif()
